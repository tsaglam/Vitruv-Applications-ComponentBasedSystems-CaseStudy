...
class ReactionsExecutor extends AbstractReactionsExecutor {
  ...
  protected void setup() {
    ...
    this.addReaction(new mir.reactions.umlToJavaMethod.UmlParameterRenamedReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("umlToJavaMethod"))));
    ...
    this.addReaction(new mir.reactions.umlToJavaMethod.UmlParameterDirectionChangedFromInReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("umlToJavaMethod"))));
    this.addReaction(new mir.reactions.umlToJavaMethod.UmlParameterDirectionChangedFromReturnReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("umlToJavaMethod"))));
    this.addReaction(new mir.reactions.umlToJavaMethod.UmlParameterDirectionChangedToInReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("umlToJavaMethod"))));
    this.addReaction(new mir.reactions.umlToJavaMethod.UmlParameterDirectionChangedToReturnReaction(this.getRoutinesFacadesProvider().getRoutinesFacade(ReactionsImportPath.fromPathString("umlToJavaMethod"))));

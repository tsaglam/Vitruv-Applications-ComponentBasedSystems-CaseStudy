...
public class OnSignatureNameReplacedAtOperation_nameBidirectionalRepairRoutine extends AbstractRepairRoutineRealization {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final Operation affectedEObject, @Extension final mir.routines.umlXpcmSignature_L2R.RoutinesFacade _routinesFacade) {
      _routinesFacade.signature_BidirectionalCheck(affectedEObject, "updateSignaturePcmName");
    }
  }
  
  public OnSignatureNameReplacedAtOperation_nameBidirectionalRepairRoutine(final mir.routines.umlXpcmSignature_L2R.RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Operation affectedEObject) {

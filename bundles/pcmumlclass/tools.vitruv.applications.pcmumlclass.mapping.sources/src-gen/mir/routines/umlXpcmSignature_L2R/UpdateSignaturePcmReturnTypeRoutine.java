...
public class UpdateSignaturePcmReturnTypeRoutine extends AbstractRepairRoutineRealization {
  ...
  public UpdateSignaturePcmReturnTypeRoutine(final mir.routines.umlXpcmSignature_L2R.RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Operation operation, final Parameter returnParameter, final Interface interface_) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.umlXpcmSignature_L2R.UpdateSignaturePcmReturnTypeRoutine.ActionUserExecution(getExecutionState(), this);

...
public class CompositeDatatypeParent_ElementCreatedCheckRoutine extends AbstractRepairRoutineRealization {
  ...
  public CompositeDatatypeParent_ElementCreatedCheckRoutine(final mir.routines.umlXpcmDatatypes_R2L.RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final EObject affectedEObject) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.umlXpcmDatatypes_R2L.CompositeDatatypeParent_ElementCreatedCheckRoutine.ActionUserExecution(getExecutionState(), this);

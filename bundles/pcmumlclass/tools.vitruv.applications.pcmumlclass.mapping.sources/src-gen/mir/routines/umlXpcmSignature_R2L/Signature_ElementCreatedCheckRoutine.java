...
public class Signature_ElementCreatedCheckRoutine extends AbstractRepairRoutineRealization {
  private Signature_ElementCreatedCheckRoutine.ActionUserExecution userExecution;
  ...
  public Signature_ElementCreatedCheckRoutine(final mir.routines.umlXpcmSignature_R2L.RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final EObject affectedEObject) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.umlXpcmSignature_R2L.Signature_ElementCreatedCheckRoutine.ActionUserExecution(getExecutionState(), this);
  ...
  protected boolean executeRoutine() throws IOException {
    getLogger().debug("Called routine Signature_ElementCreatedCheckRoutine with input:");

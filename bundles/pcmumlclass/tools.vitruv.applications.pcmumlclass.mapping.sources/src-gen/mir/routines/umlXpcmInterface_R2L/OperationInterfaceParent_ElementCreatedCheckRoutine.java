...
public class OperationInterfaceParent_ElementCreatedCheckRoutine extends AbstractRepairRoutineRealization {
  ...
  public OperationInterfaceParent_ElementCreatedCheckRoutine(final mir.routines.umlXpcmInterface_R2L.RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final EObject affectedEObject) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.umlXpcmInterface_R2L.OperationInterfaceParent_ElementCreatedCheckRoutine.ActionUserExecution(getExecutionState(), this);

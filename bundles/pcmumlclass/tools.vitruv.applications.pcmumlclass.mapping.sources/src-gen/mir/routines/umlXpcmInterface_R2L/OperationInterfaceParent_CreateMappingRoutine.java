...
public class OperationInterfaceParent_CreateMappingRoutine extends AbstractRepairRoutineRealization {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final OperationInterface operationInterface_, final OperationInterface parentInterface_, final Interface interface_, final Generalization generalization_, @Extension final mir.routines.umlXpcmInterface_R2L.RoutinesFacade _routinesFacade) {
    ...
    public void executeAction1(final OperationInterface operationInterface_, final OperationInterface parentInterface_, final Interface interface_, final Generalization generalization_, @Extension final mir.routines.umlXpcmInterface_R2L.RoutinesFacade _routinesFacade) {
  ...
  public OperationInterfaceParent_CreateMappingRoutine(final mir.routines.umlXpcmInterface_R2L.RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final OperationInterface operationInterface_, final OperationInterface parentInterface_) {

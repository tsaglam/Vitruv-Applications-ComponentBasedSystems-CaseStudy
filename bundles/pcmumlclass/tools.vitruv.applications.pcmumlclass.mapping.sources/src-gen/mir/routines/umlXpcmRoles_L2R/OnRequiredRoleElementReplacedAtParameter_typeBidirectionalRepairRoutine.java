...
public class OnRequiredRoleElementReplacedAtParameter_typeBidirectionalRepairRoutine extends AbstractRepairRoutineRealization {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final TypedElement affectedEObject, @Extension final mir.routines.umlXpcmRoles_L2R.RoutinesFacade _routinesFacade) {
      _routinesFacade.requiredRole_BidirectionalCheck(affectedEObject, "changeTypeOfCorrespondingRequiredRole");
    }
  }
  
  public OnRequiredRoleElementReplacedAtParameter_typeBidirectionalRepairRoutine(final mir.routines.umlXpcmRoles_L2R.RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final TypedElement affectedEObject) {

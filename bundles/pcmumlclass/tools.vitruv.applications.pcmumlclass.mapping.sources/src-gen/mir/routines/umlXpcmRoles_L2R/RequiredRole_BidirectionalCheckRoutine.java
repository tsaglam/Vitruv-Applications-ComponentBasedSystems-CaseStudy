                    ...
                    if (_tripleEquals) {
                      ...
                      if (((implementation__candidate != null) && (implementation__candidate instanceof org.eclipse.uml2.uml.Class))) {
                        org.eclipse.uml2.uml.Class implementation_ = ((org.eclipse.uml2.uml.Class) implementation__candidate);
                        {
                          {
                            if ((routineName == "updateRequiredRoleName")) {
                              _routinesFacade.updateRequiredRoleName(property__1, parameter_, implementation_, interface_, operation_);
                            }
                            if ((routineName == "changeTypeOfCorrespondingRequiredRole")) {
                              _routinesFacade.changeTypeOfCorrespondingRequiredRole(property__1, parameter_, implementation_, interface_, operation_);
                            }
                          }
                          return;
                        }
                    ...
                    if (_tripleEquals) {
                      ...
                      if (((operation__candidate != null) && (operation__candidate instanceof Operation))) {
                        Operation operation_ = ((Operation) operation__candidate);
                        {
                          {
                            if ((routineName == "updateRequiredRoleName")) {
                              _routinesFacade.updateRequiredRoleName(property__1, parameter__1, implementation_, interface_, operation_);
                            }
                            if ((routineName == "changeTypeOfCorrespondingRequiredRole")) {
                              _routinesFacade.changeTypeOfCorrespondingRequiredRole(property__1, parameter__1, implementation_, interface_, operation_);
                            }
                          }
                          return;
                        }
                      ...
                      org.eclipse.uml2.uml.Class implementation__1 = ((org.eclipse.uml2.uml.Class) implementation__candidate);
                      {
                        ...
                        if (((operation__candidate != null) && (operation__candidate instanceof Operation))) {
                          Operation operation_ = ((Operation) operation__candidate);
                          {
                            {
                              if ((routineName == "updateRequiredRoleName")) {
                                _routinesFacade.updateRequiredRoleName(property__2, parameter__1, implementation__1, interface_, operation_);
                              }
                              if ((routineName == "changeTypeOfCorrespondingRequiredRole")) {
                                _routinesFacade.changeTypeOfCorrespondingRequiredRole(property__2, parameter__1, implementation__1, interface_, operation_);
                              }
                            }
                            return;
                          }
                    ...
                    if (_tripleEquals_2) {
                      ...
                      if (((implementation__candidate_1 != null) && (implementation__candidate_1 instanceof org.eclipse.uml2.uml.Class))) {
                        org.eclipse.uml2.uml.Class implementation__2 = ((org.eclipse.uml2.uml.Class) implementation__candidate_1);
                        {
                          {
                            if ((routineName == "updateRequiredRoleName")) {
                              _routinesFacade.updateRequiredRoleName(property__3, parameter__2, implementation__2, interface__1, operation_);
                            }
                            if ((routineName == "changeTypeOfCorrespondingRequiredRole")) {
                              _routinesFacade.changeTypeOfCorrespondingRequiredRole(property__3, parameter__2, implementation__2, interface__1, operation_);
                            }
                          }
                          return;
                        }

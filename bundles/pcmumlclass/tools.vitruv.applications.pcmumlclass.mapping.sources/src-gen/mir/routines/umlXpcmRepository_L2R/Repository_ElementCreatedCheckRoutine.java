...
public class Repository_ElementCreatedCheckRoutine extends AbstractRepairRoutineRealization {
  private Repository_ElementCreatedCheckRoutine.ActionUserExecution userExecution;
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final EObject affectedEObject, @Extension final mir.routines.umlXpcmRepository_L2R.RoutinesFacade _routinesFacade) {
            ...
            if (_tripleEquals) {
              ...
              for (final PackageableElement contractsPkg__candidate : _packagedElements_1) {
                if (((contractsPkg__candidate != null) && (contractsPkg__candidate instanceof org.eclipse.uml2.uml.Package))) {
                  ...
                  if (_tripleEquals_1) {
                    _routinesFacade.repository_CreateMapping(repositoryPkg_, contractsPkg_, datatypesPkg_);
                    return;
                  }
                }
              }
          ...
          if (((repositoryPkg__candidate != null) && (repositoryPkg__candidate instanceof org.eclipse.uml2.uml.Package))) {
            ...
            for (final PackageableElement datatypesPkg__candidate_1 : _packagedElements_2) {
              if (((datatypesPkg__candidate_1 != null) && (datatypesPkg__candidate_1 instanceof org.eclipse.uml2.uml.Package))) {
                ...
                if (_tripleEquals_3) {
                  _routinesFacade.repository_CreateMapping(repositoryPkg__1, contractsPkg__1, datatypesPkg__1);
                  return;
                }
              }
            }
          ...
          if (((repositoryPkg__candidate_1 != null) && (repositoryPkg__candidate_1 instanceof org.eclipse.uml2.uml.Package))) {
            ...
            for (final PackageableElement contractsPkg__candidate_1 : _packagedElements_3) {
              if (((contractsPkg__candidate_1 != null) && (contractsPkg__candidate_1 instanceof org.eclipse.uml2.uml.Package))) {
                ...
                if (_tripleEquals_5) {
                  _routinesFacade.repository_CreateMapping(repositoryPkg__2, contractsPkg__2, datatypesPkg__2);
                  return;
                }
              }
            }
  ...
  public Repository_ElementCreatedCheckRoutine(final mir.routines.umlXpcmRepository_L2R.RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final EObject affectedEObject) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.umlXpcmRepository_L2R.Repository_ElementCreatedCheckRoutine.ActionUserExecution(getExecutionState(), this);
  ...
  protected boolean executeRoutine() throws IOException {
    getLogger().debug("Called routine Repository_ElementCreatedCheckRoutine with input:");

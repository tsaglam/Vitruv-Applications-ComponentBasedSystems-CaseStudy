...
public class Repository_BidirectionalCheckRoutine extends AbstractRepairRoutineRealization {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final EObject affectedEObject, final String routineName, @Extension final mir.routines.umlXpcmRepository_R2L.RoutinesFacade _routinesFacade) {
  ...
  public Repository_BidirectionalCheckRoutine(final mir.routines.umlXpcmRepository_R2L.RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final EObject affectedEObject, final String routineName) {

...
public class OnRepositoryComponentNameReplacedAtOperation_nameBidirectionalRepairRoutine extends AbstractRepairRoutineRealization {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final Operation affectedEObject, @Extension final mir.routines.umlXpcmComponent_L2R.RoutinesFacade _routinesFacade) {
      _routinesFacade.repositoryComponent_BidirectionalCheck(affectedEObject, "updateComponentName");
    }
  }
  
  public OnRepositoryComponentNameReplacedAtOperation_nameBidirectionalRepairRoutine(final mir.routines.umlXpcmComponent_L2R.RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final Operation affectedEObject) {

...
public class OperationInterface_ElementCreatedCheckRoutine extends AbstractRepairRoutineRealization {
  private OperationInterface_ElementCreatedCheckRoutine.ActionUserExecution userExecution;
  ...
  public OperationInterface_ElementCreatedCheckRoutine(final mir.routines.umlXpcmInterface_L2R.RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final EObject affectedEObject) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.umlXpcmInterface_L2R.OperationInterface_ElementCreatedCheckRoutine.ActionUserExecution(getExecutionState(), this);
  ...
  protected boolean executeRoutine() throws IOException {
    getLogger().debug("Called routine OperationInterface_ElementCreatedCheckRoutine with input:");

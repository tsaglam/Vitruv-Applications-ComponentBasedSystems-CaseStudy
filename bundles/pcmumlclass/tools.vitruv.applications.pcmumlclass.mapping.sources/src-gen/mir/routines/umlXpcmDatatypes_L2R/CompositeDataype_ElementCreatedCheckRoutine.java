...
public class CompositeDataype_ElementCreatedCheckRoutine extends AbstractRepairRoutineRealization {
  ...
  public CompositeDataype_ElementCreatedCheckRoutine(final mir.routines.umlXpcmDatatypes_L2R.RoutinesFacade routinesFacade, final ReactionExecutionState reactionExecutionState, final CallHierarchyHaving calledBy, final EObject affectedEObject) {
    super(routinesFacade, reactionExecutionState, calledBy);
    this.userExecution = new mir.routines.umlXpcmDatatypes_L2R.CompositeDataype_ElementCreatedCheckRoutine.ActionUserExecution(getExecutionState(), this);

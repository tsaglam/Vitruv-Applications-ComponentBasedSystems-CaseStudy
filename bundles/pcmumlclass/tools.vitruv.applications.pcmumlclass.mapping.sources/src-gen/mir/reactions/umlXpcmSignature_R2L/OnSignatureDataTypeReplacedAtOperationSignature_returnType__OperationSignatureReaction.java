...
public class OnSignatureDataTypeReplacedAtOperationSignature_returnType__OperationSignatureReaction extends AbstractReactionRealization {
  private ReplaceSingleValuedEReference<OperationSignature, DataType> replaceChange;
  
  private int currentlyMatchedChange;
  
  public OnSignatureDataTypeReplacedAtOperationSignature_returnType__OperationSignatureReaction(final mir.routines.umlXpcmSignature_R2L.RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmSignature_R2L.OnSignatureDataTypeReplacedAtOperationSignature_returnType__OperationSignatureReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmSignature_R2L.OnSignatureDataTypeReplacedAtOperationSignature_returnType__OperationSignatureReaction.ActionUserExecution(this.executionState, this);

...
public class OnRepositoryComponentRepositoryDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<Repository> deleteChange;
  
  private int currentlyMatchedChange;
  
  public OnRepositoryComponentRepositoryDeletedReaction(final mir.routines.umlXpcmComponent_R2L.RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmComponent_R2L.OnRepositoryComponentRepositoryDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmComponent_R2L.OnRepositoryComponentRepositoryDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final Repository affectedEObject, @Extension final mir.routines.umlXpcmComponent_R2L.RoutinesFacade _routinesFacade) {

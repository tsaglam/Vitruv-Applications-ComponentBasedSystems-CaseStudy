...
public class OnCompositeDatatypeParentGeneralizationDeletedReaction extends AbstractReactionRealization {
  ...
  public OnCompositeDatatypeParentGeneralizationDeletedReaction(final mir.routines.umlXpcmDatatypes_L2R.RoutinesFacade routinesFacade) {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final Generalization affectedEObject, @Extension final mir.routines.umlXpcmDatatypes_L2R.RoutinesFacade _routinesFacade) {

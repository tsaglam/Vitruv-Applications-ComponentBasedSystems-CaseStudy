...
public class OnProvidedRoleInterfaceDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<Interface> deleteChange;
  
  private int currentlyMatchedChange;
  
  public OnProvidedRoleInterfaceDeletedReaction(final mir.routines.umlXpcmRoles_L2R.RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmRoles_L2R.OnProvidedRoleInterfaceDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmRoles_L2R.OnProvidedRoleInterfaceDeletedReaction.ActionUserExecution(this.executionState, this);

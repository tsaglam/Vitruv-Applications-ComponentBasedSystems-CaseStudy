...
public class OnRequiredRoleNameReplacedAtProperty_nameBidirectionalReaction extends AbstractReactionRealization {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmRoles_L2R.OnRequiredRoleNameReplacedAtProperty_nameBidirectionalReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmRoles_L2R.OnRequiredRoleNameReplacedAtProperty_nameBidirectionalReaction.ActionUserExecution(this.executionState, this);
  ...
  private boolean matchReplaceChange(final EChange change) {
    if (change instanceof ReplaceSingleValuedEAttribute<?, ?>) {
    	ReplaceSingleValuedEAttribute<org.eclipse.uml2.uml.Property, java.lang.String> _localTypedChange = (ReplaceSingleValuedEAttribute<org.eclipse.uml2.uml.Property, java.lang.String>) change;
    	...
    	this.replaceChange = (ReplaceSingleValuedEAttribute<org.eclipse.uml2.uml.Property, java.lang.String>) change;
    	return true;
    }

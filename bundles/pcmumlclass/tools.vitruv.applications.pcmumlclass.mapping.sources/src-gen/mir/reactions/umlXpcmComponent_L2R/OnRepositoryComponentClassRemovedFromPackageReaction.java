...
public class OnRepositoryComponentClassRemovedFromPackageReaction extends AbstractReactionRealization {
  private RemoveEReference<org.eclipse.uml2.uml.Package, org.eclipse.uml2.uml.Class> removeChange;
  
  private int currentlyMatchedChange;
  
  public OnRepositoryComponentClassRemovedFromPackageReaction(final mir.routines.umlXpcmComponent_L2R.RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmComponent_L2R.OnRepositoryComponentClassRemovedFromPackageReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmComponent_L2R.OnRepositoryComponentClassRemovedFromPackageReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final RemoveEReference removeChange, final org.eclipse.uml2.uml.Package affectedEObject, final EReference affectedFeature, final org.eclipse.uml2.uml.Class oldValue, final int index, @Extension final mir.routines.umlXpcmComponent_L2R.RoutinesFacade _routinesFacade) {

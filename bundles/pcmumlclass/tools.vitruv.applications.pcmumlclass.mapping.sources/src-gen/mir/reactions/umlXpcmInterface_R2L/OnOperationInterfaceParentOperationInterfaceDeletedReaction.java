...
public class OnOperationInterfaceParentOperationInterfaceDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<OperationInterface> deleteChange;
  
  private int currentlyMatchedChange;
  
  public OnOperationInterfaceParentOperationInterfaceDeletedReaction(final mir.routines.umlXpcmInterface_R2L.RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmInterface_R2L.OnOperationInterfaceParentOperationInterfaceDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmInterface_R2L.OnOperationInterfaceParentOperationInterfaceDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final OperationInterface affectedEObject, @Extension final mir.routines.umlXpcmInterface_R2L.RoutinesFacade _routinesFacade) {

...
public class OnOperationInterfaceRepositoryDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<Repository> deleteChange;
  
  private int currentlyMatchedChange;
  
  public OnOperationInterfaceRepositoryDeletedReaction(final mir.routines.umlXpcmInterface_R2L.RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmInterface_R2L.OnOperationInterfaceRepositoryDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmInterface_R2L.OnOperationInterfaceRepositoryDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final Repository affectedEObject, @Extension final mir.routines.umlXpcmInterface_R2L.RoutinesFacade _routinesFacade) {

...
public class OnOperationInterfaceOperationInterfaceDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<OperationInterface> deleteChange;
  
  private int currentlyMatchedChange;
  
  public OnOperationInterfaceOperationInterfaceDeletedReaction(final mir.routines.umlXpcmInterface_R2L.RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmInterface_R2L.OnOperationInterfaceOperationInterfaceDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmInterface_R2L.OnOperationInterfaceOperationInterfaceDeletedReaction.ActionUserExecution(this.executionState, this);

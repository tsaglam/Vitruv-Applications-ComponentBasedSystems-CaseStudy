...
public class OnProvidedRoleInterfaceProvidingRequiringEntityDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<InterfaceProvidingRequiringEntity> deleteChange;
  
  private int currentlyMatchedChange;
  
  public OnProvidedRoleInterfaceProvidingRequiringEntityDeletedReaction(final mir.routines.umlXpcmRoles_R2L.RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmRoles_R2L.OnProvidedRoleInterfaceProvidingRequiringEntityDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmRoles_R2L.OnProvidedRoleInterfaceProvidingRequiringEntityDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final InterfaceProvidingRequiringEntity affectedEObject, @Extension final mir.routines.umlXpcmRoles_R2L.RoutinesFacade _routinesFacade) {

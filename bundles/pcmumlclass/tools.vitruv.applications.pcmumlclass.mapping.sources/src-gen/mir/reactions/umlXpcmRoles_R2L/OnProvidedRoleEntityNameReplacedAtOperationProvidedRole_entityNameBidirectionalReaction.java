...
public class OnProvidedRoleEntityNameReplacedAtOperationProvidedRole_entityNameBidirectionalReaction extends AbstractReactionRealization {
  ...
  public OnProvidedRoleEntityNameReplacedAtOperationProvidedRole_entityNameBidirectionalReaction(final mir.routines.umlXpcmRoles_R2L.RoutinesFacade routinesFacade) {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEAttribute replaceChange, final OperationProvidedRole affectedEObject, final EAttribute affectedFeature, final String oldValue, final String newValue, @Extension final mir.routines.umlXpcmRoles_R2L.RoutinesFacade _routinesFacade) {

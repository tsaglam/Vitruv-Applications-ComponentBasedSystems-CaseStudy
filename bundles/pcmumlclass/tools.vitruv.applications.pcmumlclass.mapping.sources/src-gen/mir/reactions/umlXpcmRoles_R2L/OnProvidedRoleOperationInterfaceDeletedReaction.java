...
public class OnProvidedRoleOperationInterfaceDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<OperationInterface> deleteChange;
  
  private int currentlyMatchedChange;
  
  public OnProvidedRoleOperationInterfaceDeletedReaction(final mir.routines.umlXpcmRoles_R2L.RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmRoles_R2L.OnProvidedRoleOperationInterfaceDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmRoles_R2L.OnProvidedRoleOperationInterfaceDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final OperationInterface affectedEObject, @Extension final mir.routines.umlXpcmRoles_R2L.RoutinesFacade _routinesFacade) {

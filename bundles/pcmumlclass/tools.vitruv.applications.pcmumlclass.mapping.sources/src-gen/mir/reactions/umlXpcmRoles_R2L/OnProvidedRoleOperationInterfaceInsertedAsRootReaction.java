...
public class OnProvidedRoleOperationInterfaceInsertedAsRootReaction extends AbstractReactionRealization {
  private CreateEObject<OperationInterface> createChange;
  
  private int currentlyMatchedChange;
  
  public OnProvidedRoleOperationInterfaceInsertedAsRootReaction(final mir.routines.umlXpcmRoles_R2L.RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmRoles_R2L.OnProvidedRoleOperationInterfaceInsertedAsRootReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmRoles_R2L.OnProvidedRoleOperationInterfaceInsertedAsRootReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final CreateEObject createChange, final OperationInterface affectedEObject, @Extension final mir.routines.umlXpcmRoles_R2L.RoutinesFacade _routinesFacade) {

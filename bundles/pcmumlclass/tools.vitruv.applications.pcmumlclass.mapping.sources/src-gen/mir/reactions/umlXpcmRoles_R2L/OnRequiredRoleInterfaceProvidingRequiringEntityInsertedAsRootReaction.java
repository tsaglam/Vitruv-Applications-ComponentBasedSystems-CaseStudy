...
public class OnRequiredRoleInterfaceProvidingRequiringEntityInsertedAsRootReaction extends AbstractReactionRealization {
  private CreateEObject<InterfaceProvidingRequiringEntity> createChange;
  
  private int currentlyMatchedChange;
  
  public OnRequiredRoleInterfaceProvidingRequiringEntityInsertedAsRootReaction(final mir.routines.umlXpcmRoles_R2L.RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmRoles_R2L.OnRequiredRoleInterfaceProvidingRequiringEntityInsertedAsRootReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmRoles_R2L.OnRequiredRoleInterfaceProvidingRequiringEntityInsertedAsRootReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final CreateEObject createChange, final InterfaceProvidingRequiringEntity affectedEObject, @Extension final mir.routines.umlXpcmRoles_R2L.RoutinesFacade _routinesFacade) {

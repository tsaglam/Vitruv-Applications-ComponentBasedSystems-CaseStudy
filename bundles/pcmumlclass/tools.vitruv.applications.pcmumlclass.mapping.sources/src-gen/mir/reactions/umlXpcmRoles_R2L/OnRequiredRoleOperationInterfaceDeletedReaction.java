...
public class OnRequiredRoleOperationInterfaceDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<OperationInterface> deleteChange;
  
  private int currentlyMatchedChange;
  
  public OnRequiredRoleOperationInterfaceDeletedReaction(final mir.routines.umlXpcmRoles_R2L.RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmRoles_R2L.OnRequiredRoleOperationInterfaceDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmRoles_R2L.OnRequiredRoleOperationInterfaceDeletedReaction.ActionUserExecution(this.executionState, this);

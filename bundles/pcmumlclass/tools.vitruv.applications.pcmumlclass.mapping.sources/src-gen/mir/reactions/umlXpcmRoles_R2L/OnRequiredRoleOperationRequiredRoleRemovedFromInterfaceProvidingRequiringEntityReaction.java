...
public class OnRequiredRoleOperationRequiredRoleRemovedFromInterfaceProvidingRequiringEntityReaction extends AbstractReactionRealization {
  private RemoveEReference<InterfaceRequiringEntity, OperationRequiredRole> removeChange;
  
  private int currentlyMatchedChange;
  
  public OnRequiredRoleOperationRequiredRoleRemovedFromInterfaceProvidingRequiringEntityReaction(final mir.routines.umlXpcmRoles_R2L.RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmRoles_R2L.OnRequiredRoleOperationRequiredRoleRemovedFromInterfaceProvidingRequiringEntityReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmRoles_R2L.OnRequiredRoleOperationRequiredRoleRemovedFromInterfaceProvidingRequiringEntityReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final RemoveEReference removeChange, final InterfaceRequiringEntity affectedEObject, final EReference affectedFeature, final OperationRequiredRole oldValue, final int index, @Extension final mir.routines.umlXpcmRoles_R2L.RoutinesFacade _routinesFacade) {

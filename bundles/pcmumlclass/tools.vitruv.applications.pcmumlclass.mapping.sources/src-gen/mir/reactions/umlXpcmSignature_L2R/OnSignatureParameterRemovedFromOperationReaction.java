...
public class OnSignatureParameterRemovedFromOperationReaction extends AbstractReactionRealization {
  private RemoveEReference<BehavioralFeature, Parameter> removeChange;
  
  private int currentlyMatchedChange;
  
  public OnSignatureParameterRemovedFromOperationReaction(final mir.routines.umlXpcmSignature_L2R.RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmSignature_L2R.OnSignatureParameterRemovedFromOperationReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmSignature_L2R.OnSignatureParameterRemovedFromOperationReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final RemoveEReference removeChange, final BehavioralFeature affectedEObject, final EReference affectedFeature, final Parameter oldValue, final int index, @Extension final mir.routines.umlXpcmSignature_L2R.RoutinesFacade _routinesFacade) {

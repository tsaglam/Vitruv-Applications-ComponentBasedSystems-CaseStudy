...
public class OnSignatureNameReplacedAtParameter_nameReaction extends AbstractReactionRealization {
  ...
  public OnSignatureNameReplacedAtParameter_nameReaction(final mir.routines.umlXpcmSignature_L2R.RoutinesFacade routinesFacade) {
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final ReplaceSingleValuedEAttribute replaceChange, final Parameter affectedEObject, final EAttribute affectedFeature, final String oldValue, final String newValue, @Extension final mir.routines.umlXpcmSignature_L2R.RoutinesFacade _routinesFacade) {

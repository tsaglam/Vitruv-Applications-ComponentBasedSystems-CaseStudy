...
public class OnCompositeDataypeRepositoryDeletedReaction extends AbstractReactionRealization {
  private DeleteEObject<Repository> deleteChange;
  
  private int currentlyMatchedChange;
  
  public OnCompositeDataypeRepositoryDeletedReaction(final mir.routines.umlXpcmDatatypes_R2L.RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmDatatypes_R2L.OnCompositeDataypeRepositoryDeletedReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmDatatypes_R2L.OnCompositeDataypeRepositoryDeletedReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final DeleteEObject deleteChange, final Repository affectedEObject, @Extension final mir.routines.umlXpcmDatatypes_R2L.RoutinesFacade _routinesFacade) {

...
public class OnCompositeDatatypeParentCompositeDataTypeInsertedInCompositeDataTypeReaction extends AbstractReactionRealization {
  private InsertEReference<CompositeDataType, CompositeDataType> insertChange;
  
  private int currentlyMatchedChange;
  
  public OnCompositeDatatypeParentCompositeDataTypeInsertedInCompositeDataTypeReaction(final mir.routines.umlXpcmDatatypes_R2L.RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmDatatypes_R2L.OnCompositeDatatypeParentCompositeDataTypeInsertedInCompositeDataTypeReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmDatatypes_R2L.OnCompositeDatatypeParentCompositeDataTypeInsertedInCompositeDataTypeReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final InsertEReference insertChange, final CompositeDataType affectedEObject, final EReference affectedFeature, final CompositeDataType newValue, final int index, @Extension final mir.routines.umlXpcmDatatypes_R2L.RoutinesFacade _routinesFacade) {

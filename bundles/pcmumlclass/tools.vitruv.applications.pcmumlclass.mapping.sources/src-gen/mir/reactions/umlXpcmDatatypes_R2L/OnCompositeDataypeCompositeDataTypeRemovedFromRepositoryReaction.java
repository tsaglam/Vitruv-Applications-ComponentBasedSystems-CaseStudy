...
public class OnCompositeDataypeCompositeDataTypeRemovedFromRepositoryReaction extends AbstractReactionRealization {
  private RemoveEReference<Repository, CompositeDataType> removeChange;
  
  private int currentlyMatchedChange;
  
  public OnCompositeDataypeCompositeDataTypeRemovedFromRepositoryReaction(final mir.routines.umlXpcmDatatypes_R2L.RoutinesFacade routinesFacade) {
  ...
  public void executeReaction(final EChange change) {
    ...
    mir.reactions.umlXpcmDatatypes_R2L.OnCompositeDataypeCompositeDataTypeRemovedFromRepositoryReaction.ActionUserExecution userExecution = new mir.reactions.umlXpcmDatatypes_R2L.OnCompositeDataypeCompositeDataTypeRemovedFromRepositoryReaction.ActionUserExecution(this.executionState, this);
  ...
  private static class ActionUserExecution extends AbstractRepairRoutineRealization.UserExecution {
    ...
    public void callRoutine1(final RemoveEReference removeChange, final Repository affectedEObject, final EReference affectedFeature, final CompositeDataType oldValue, final int index, @Extension final mir.routines.umlXpcmDatatypes_R2L.RoutinesFacade _routinesFacade) {
